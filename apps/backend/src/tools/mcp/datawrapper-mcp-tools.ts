						...
						inputSchema: z
							.object({
								...
								chart_type: z
									...
									.describe(
										"Type of visualization to create. Scatter/range/arrow require 2+ numeric columns. Map requires map_type.",
									),
								variant: z
								...
								region_column: z
									...
									.optional()
									.describe(
										"Column with region IDs/names for choropleth maps.",
									),
								value_column: z
									.string()
									.optional()
								...
								thick: z
									.boolean()
									.optional()
									.describe("Thickness toggle for supported chart types."),
