export const Content = {
	...
	"sidebar.navigation.imprint.ariaLabel": "Zur Impressum-Seite navigieren",
	"sidebar.navigation.feedback": "Feedback geben",
	...
	"documentsToggleButton.arialabel.open": "Dokumente Abschnitt öffnen",
	"documentsToggleButton.arialabel.close": "Dokumente Abschnitt schließen",
	"documentsToggleButton.imgAlt": "Dateien Icon",
	"documentsToggleButton.label": "Dateien",
	//historyToggleButton
	"historyToggleButton.arialabel.open": "Chat-Verlauf öffnen",
	"historyToggleButton.arialabel.close": "Chat-Verlauf schließen",
	"historyToggleButton.label": "Menü",
	//newChatButton
	...
	//toast
	"toast.close.ariaLabel": "Meldung schließen",

	/* -------------------- Icons Img Alt -------------------- */
	"bucketIcon.imgAlt": "Mülleimer-Icon",
	"addToChatIcon.add.imgAlt": "Dokument zum Chat hinzufügen",
	"addToChatIcon.remove.imgAlt": "Dokument vom Chat entfernen",
	"plusIcon.imgAlt": "Plus-Icon",
	"barsIcon.imgAlt": "Menü-Icon",
	"closeIcon.imgAlt": "Ein blaues X-Icon",
	"checkboxIcon.unchecked.imgAlt": "Checkbox-icon (nicht ausgewählt)",
	"checkboxIcon.checked.imgAlt": "Checkbox-Icon (ausgewählt)",
	"checkboxIcon.indeterminate.imgAlt": "Checkbox-Icon (teilweise ausgewählt)",
	"chevronIcon.up.imgAlt": "Sparren nach oben",
	"chevronIcon.down.imgAlt": "Sparren nach unten",
	"chevronSmallIcon.right.imgAlt": "Sparren nach rechts",
	"documentIcon.imgAlt": "Dokumente-Icon",
	"folderIcon.imgAlt": "Ordner-Icon",
	"greenCheckIcon.imgAlt": "Ein grünes Häkchen-Icon",
	"greyXIcon.imgAlt": "Ein graues X-Icon",
	...
	"deleteItemDialog.cancel": "Abbrechen",
	...
	"chat.getStarted.li1": "Stelle mir eine Frage im Textfeld",
	"chat.getStarted.li2":
	...
	"chat.citationsButton.ariaLabel": "Quellen anzeigen",
	...
	"chat.exportChatTextButton.docx.ariaLabel": "Chat als DOCX exportieren",
	"chat.exportChatTextButton.docx.label": "DOCX exportieren",
	...
	"profile.h1.morning": "Guten Morgen",
	"profile.h1.afternoon": "Guten Tag",
	"profile.h1.evening": "Guten Abend",
	"profile.h1.default": "Hallo",
	"profile.h2": "Verwalten Sie Ihre persönlichen Daten und Chateinstellungen.",
	"profile.personalInfo": "Persönliche Informationen",

	"profile.backToChats": "zurück zu den Chats",

	//profile personal info form
	"profile.academicTitleLabel": "Titel",
	"profile.academicTitle.defaultOption": "keine Angabe",
	"profile.academicTitle.options": ["Dr.", "Prof.", "Prof. Dr."],
	"profile.personalTitleLabel": "Anrede",
	"profile.personalTitle.options": ["Frau", "Herr"],
	"profile.personalTitle.defaultOption": "keine Angabe",
	"profile.firstNameLabel": "Vorname",
	"profile.lastNameLabel": "Nachname",
	"profile.requiredField": "(Pflichtfeld)",
	"profile.submitButton": "Änderungen speichern",
	"profile.profileUpdateSuccess": "Änderungen wurden aktualisiert",
	//profile delete account
	"profile.deleteAccount": "Konto löschen",
	"profile.deleteAccount.label": "Mein Konto unwiderruflich löschen.",
	"profile.deleteAccount.description":
		"Mit dem unwiderruflichen Löschen haben Sie keinen Zugriff mehr auf Ihre Chats und Dokumente.",
	"profile.deleteAccount.button": "Konto unwiderruflich löschen",
	"profile.deleteAccount.dialog.title": "Mein Konto unwiderruflich löschen",
	...
	"profile.changeEmailForm.label": "E-Mail-Adresse",
	"profile.changeEmailForm.submitButton": "E-Mail-Adresse ändern",
	"profile.changeEmailForm.dialog.title": "Verifizierungs-E-Mail versendet an",
	"profile.changeEmailForm.dialog.hint":
		"Bestätigen Sie die E-Mail in Ihrem Postfach.",
	"profile.changeEmailForm.dialog.closeButton": "Schließen",
	"profile.changeEmailForm.dialog.ariaLabel": "E-Mail-Dialog schließen",
	"profile.changeEmailForm.dialog.title.ariaLabel": "E-Mail-Dialog Titel",
	"profile.changeEmailForm.hint.p1":
		"Sie haben die Änderung Ihrer E-Mail-Adresse auf",
	"profile.changeEmailForm.hint.p2": "beantragt.",
	"profile.changeEmailForm.hint.p3":
		"Bitte bestätigen Sie die neue Adresse über den Link, den wir an",
	"profile.changeEmailForm.hint.p4": "gesendet haben.",
	"profile.changeEmailForm.error":
		"Die E-Mail-Adresse konnte nicht geändert werden. Bitte versuchen Sie es später erneut.",
	"profile.changeEmailForm.emailInUseError":
		"Die E-Mail-Adresse ist bereits vergeben. Bitte verwenden Sie eine andere.",
	"profile.chatSettings.title": "Chateinstellungen",
	"profile.chatSettings.salutation":
		"BärGPT spricht Sie persönlich mit ‚du‘ an.",
	...
	"accountDeleted.description":
		"Schade, dass Sie gehen. Helfen Sie uns, BärGPT zu verbessern. Wir freuen uns über Feedback.",
	...
	"registerPage.lastNamePlaceholder": "Müller",
...
<ul class="list-disc pl-5">
	...
	"accountActivated.h2": "Bitte vervollständigen Sie Ihr Profil",

	"accountActivated.academicTitleLabel": "Titel",
	"accountActivated.academicTitle.defaultOption": "keine Angabe",
	"accountActivated.academicTitle.options": ["Dr.", "Prof.", "Prof. Dr."],
	"accountActivated.personalTitleLabel": "Anrede",
	"accountActivated.personalTitle.options": ["Frau", "Herr"],
	"accountActivated.personalTitle.defaultOption": "keine Angabe",
	"accountActivated.firstNameLabel": "Vorname",
	...
	"accountActivated.submitButton": "Registrieren",
