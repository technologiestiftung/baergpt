...
export const DesktopProfileButton = () => {
	...
	return (
		<>
			...
			>
				<div
					className={`flex items-center rounded-full size-[33px] p-2 group-hover:bg-hellblau-100 ${isDropdownOpen ? "bg-hellblau-100 group-hover:bg-hellblau-60" : "bg-hellblau-60"}`}
				>
