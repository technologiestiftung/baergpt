...
export const RemoveFromChatButton: React.FC<RemoveFromChatButtonProps> = ({
	...
	return (
		<button
			className="flex rounded-3px w-fit items-center px-2 gap-1.5 text-dunkelblau-100 bg-hellblau-100 text-sm leading-5 font-normal hover:bg-mittelblau-70 focus-visible:outline-default h-8"
			type="button"
