	...
	return (
		<>
			<button
				...
				className={`flex flex-col items-center justify-center gap-1 md:gap-1 size-[52px] p-2 md:p-1 md:h-[30px] md:w-auto rounded-[3px] text-hellblau-50 md:hover:bg-dunkelblau-90 focus-visible:outline-default
