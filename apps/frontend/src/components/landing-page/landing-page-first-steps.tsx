...
export function LandingPageFirstSteps() {
	return (
		<div className="flex flex-col pt-[60px] sm:pt-20 px-5 lg:px-0 text-dunkelblau-100 gap-2 sm:gap-5 lg:gap-12 max-w-[934px] mx-auto">
			...
			<iframe
				...
				src="https://player.vimeo.com/video/1082104093?&color=1E3791&title=0&byline=0&portrait=0&texttrack=de"
